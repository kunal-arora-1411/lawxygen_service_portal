...
export const metadata: Metadata = {
  ...
  description: "A guided path for pan card application that keeps preparation, filing and follow-up easy to understand.",
};
...
const data = {
  ...
  "summary": "A guided path for pan card application that keeps preparation, filing and follow-up easy to understand.",
  "highlights": [
  ...
  "overview": [
    "PAN Card Application is a structured business or legal setup service. The first step is to understand who is applying, what outcome is required and which route applies.",
  ...
  "faqs": [
    [
      "What is PAN Card Application?",
      "PAN Card Application is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to pan card application. The exact checklist can vary by case."
    ],
    [
