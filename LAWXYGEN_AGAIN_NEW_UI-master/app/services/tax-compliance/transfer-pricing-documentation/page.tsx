...
export const metadata: Metadata = {
  ...
  description: "A clear LAWXYGEN workflow for transfer pricing documentation, with concise guidance, preparation and an obvious next action.",
};
...
const data = {
  ...
  "variant": 2,
  "archetype": "general",
  "summary": "A clear LAWXYGEN workflow for transfer pricing documentation, with concise guidance, preparation and an obvious next action.",
  "highlights": [
  ...
  "overview": [
    "Transfer Pricing Documentation is presented as a focused LAWXYGEN service journey rather than a generic information page.",
