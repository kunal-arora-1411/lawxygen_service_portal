...
export const metadata: Metadata = {
  ...
  description: "Keep gst annual return filing (gstr-9c) organised around records, review points and the next filing or response.",
};
...
const data = {
  ...
  "summary": "Keep gst annual return filing (gstr-9c) organised around records, review points and the next filing or response.",
  "highlights": [
    "Period-aware",
    "Record review",
    "Submission path",
  ...
  "overview": [
    "GST Annual Return Filing (GSTR-9C) is most effective when the source records are prepared before the filing, review or response stage begins.",
  ...
  "faqs": [
    [
      "What is GST Annual Return Filing (GSTR-9C)?",
      "GST Annual Return Filing (GSTR-9C) is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to gst annual return filing (gstr-9c). The exact checklist can vary by case."
    ],
    [
  ...
  "related": [
    ...
    },
    {
      ...
      "href": "/services/tax-compliance/gst-audit-support"
    }
  ],
