...
export const metadata: Metadata = {
  ...
  description: "A clear LAWXYGEN workflow for e-way bill assistance, with concise guidance, preparation and an obvious next action.",
};
...
const data = {
  ...
  "variant": 15,
  "archetype": "general",
  "summary": "A clear LAWXYGEN workflow for e-way bill assistance, with concise guidance, preparation and an obvious next action.",
  "highlights": [
  ...
  "overview": [
    "E-Way Bill Assistance is presented as a focused LAWXYGEN service journey rather than a generic information page.",
  ...
  "faqs": [
    [
      "What is E-Way Bill Assistance?",
      "E-Way Bill Assistance is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to e-way bill assistance. The exact checklist can vary by case."
    ],
    [
