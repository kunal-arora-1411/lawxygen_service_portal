...
export const metadata: Metadata = {
  ...
  description: "Bring the facts, documents and decision points together before taking the next step on online lawyer consultation.",
};
...
const data = {
  ...
  "variant": 17,
  "archetype": "advisory",
  "summary": "Bring the facts, documents and decision points together before taking the next step on online lawyer consultation.",
  "highlights": [
    "Issue framing",
    "Evidence pack",
    "Expert routing",
  ...
  "overview": [
    "Online Lawyer Consultation benefits from strong issue framing before a professional starts analysing the matter.",
  ...
  "faqs": [
    [
      "What is Online Lawyer Consultation?",
      "Online Lawyer Consultation is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to online lawyer consultation. The exact checklist can vary by case."
    ],
    [
