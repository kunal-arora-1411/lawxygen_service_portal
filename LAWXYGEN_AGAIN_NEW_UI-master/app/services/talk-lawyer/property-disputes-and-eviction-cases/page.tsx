...
const data = {
  ...
  "summary": "A focused consultation path for property disputes & eviction cases, designed to make the issue easy for the right professional to assess.",
  "highlights": [
    "Issue framing",
    "Evidence pack",
    "Expert routing",
  ...
  "overview": [
    "Property Disputes & Eviction Cases benefits from strong issue framing before a professional starts analysing the matter.",
  ...
  "faqs": [
    [
      "What is Property Disputes & Eviction Cases?",
      "Property Disputes & Eviction Cases is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to property disputes & eviction cases. The exact checklist can vary by case."
    ],
    [
