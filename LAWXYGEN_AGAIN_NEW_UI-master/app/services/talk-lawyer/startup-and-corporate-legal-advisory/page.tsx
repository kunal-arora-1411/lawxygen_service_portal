...
export const metadata: Metadata = {
  ...
  description: "Bring the facts, documents and decision points together before taking the next step on startup & corporate legal advisory.",
};
...
const data = {
  ...
  "variant": 8,
  "archetype": "advisory",
  "summary": "Bring the facts, documents and decision points together before taking the next step on startup & corporate legal advisory.",
  "highlights": [
    "Issue framing",
    "Evidence pack",
    "Expert routing",
  ...
  "overview": [
    "Startup & Corporate Legal Advisory benefits from strong issue framing before a professional starts analysing the matter.",
  ...
  "faqs": [
    [
      "What is Startup & Corporate Legal Advisory?",
      "Startup & Corporate Legal Advisory is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to startup & corporate legal advisory. The exact checklist can vary by case."
    ],
    [
