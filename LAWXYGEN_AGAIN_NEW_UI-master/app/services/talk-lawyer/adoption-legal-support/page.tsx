...
const data = {
  ...
  "variant": 18,
  "archetype": "advisory",
  "summary": "Bring the facts, documents and decision points together before taking the next step on adoption legal support.",
  "highlights": [
    "Issue framing",
    "Evidence pack",
    "Expert routing",
  ...
  "overview": [
    "Adoption Legal Support benefits from strong issue framing before a professional starts analysing the matter.",
  ...
  "faqs": [
    [
      "What is Adoption Legal Support?",
      "Adoption Legal Support is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to adoption legal support. The exact checklist can vary by case."
    ],
    [
