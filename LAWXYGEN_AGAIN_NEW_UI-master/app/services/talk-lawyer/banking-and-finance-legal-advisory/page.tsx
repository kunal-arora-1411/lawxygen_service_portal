...
export const metadata: Metadata = {
  ...
  description: "Bring the facts, documents and decision points together before taking the next step on banking & finance legal advisory.",
};
...
const data = {
  ...
  "variant": 1,
  "archetype": "advisory",
  "summary": "Bring the facts, documents and decision points together before taking the next step on banking & finance legal advisory.",
  "highlights": [
    "Issue framing",
    "Evidence pack",
    "Expert routing",
  ...
  "overview": [
    "Banking & Finance Legal Advisory benefits from strong issue framing before a professional starts analysing the matter.",
  ...
  "faqs": [
    [
      "What is Banking & Finance Legal Advisory?",
      "Banking & Finance Legal Advisory is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to banking & finance legal advisory. The exact checklist can vary by case."
    ],
    [
