...
const data = {
  ...
  "summary": "A guided path for fssai food license registration (basic / state / central) that keeps preparation, filing and follow-up easy to understand.",
  "highlights": [
  ...
  "overview": [
    "FSSAI Food License Registration (Basic / State / Central) is a structured business or legal setup service. The first step is to understand who is applying, what outcome is required and which route applies.",
  ...
  "faqs": [
    [
      "What is FSSAI Food License Registration (Basic / State / Central)?",
      "FSSAI Food License Registration (Basic / State / Central) is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to fssai food license registration (basic / state / central). The exact checklist can vary by case."
    ],
    [
