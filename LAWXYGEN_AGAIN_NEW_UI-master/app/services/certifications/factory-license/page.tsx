...
export const metadata: Metadata = {
  ...
  description: "A clear LAWXYGEN workflow for factory license, with concise guidance, preparation and an obvious next action.",
};
...
const data = {
  ...
  "variant": 18,
  "archetype": "general",
  "summary": "A clear LAWXYGEN workflow for factory license, with concise guidance, preparation and an obvious next action.",
  "highlights": [
  ...
  "overview": [
    "Factory License is presented as a focused LAWXYGEN service journey rather than a generic information page.",
  ...
  "faqs": [
    [
      ...
      "Factory License is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to factory license. The exact checklist can vary by case."
    ],
    [
