...
export const metadata: Metadata = {
  ...
  description: "A clear LAWXYGEN workflow for fssai license renewal, with concise guidance, preparation and an obvious next action.",
};
...
const data = {
  ...
  "variant": 8,
  "archetype": "general",
  "summary": "A clear LAWXYGEN workflow for fssai license renewal, with concise guidance, preparation and an obvious next action.",
  "highlights": [
  ...
  "overview": [
    "FSSAI License Renewal is presented as a focused LAWXYGEN service journey rather than a generic information page.",
  ...
  "faqs": [
    [
      ...
      "FSSAI License Renewal is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to fssai license renewal. The exact checklist can vary by case."
    ],
    [
