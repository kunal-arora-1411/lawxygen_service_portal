...
const data = {
  ...
  "variant": 23,
  "archetype": "general",
  "summary": "A clear LAWXYGEN workflow for fire safety license (noc), with concise guidance, preparation and an obvious next action.",
  "highlights": [
  ...
  "overview": [
    "Fire Safety License (NOC) is presented as a focused LAWXYGEN service journey rather than a generic information page.",
  ...
  "faqs": [
    [
      ...
      "Fire Safety License (NOC) is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to fire safety license (noc). The exact checklist can vary by case."
    ],
    [
