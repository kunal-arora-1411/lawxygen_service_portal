...
export const metadata: Metadata = {
  ...
  description: "Bring the facts, documents and decision points together before taking the next step on venture capital funding legal support.",
};
...
const data = {
  ...
  "variant": 22,
  "archetype": "advisory",
  "summary": "Bring the facts, documents and decision points together before taking the next step on venture capital funding legal support.",
  "highlights": [
    "Issue framing",
    "Evidence pack",
    "Expert routing",
  ...
  "overview": [
    "Venture Capital Funding Legal Support benefits from strong issue framing before a professional starts analysing the matter.",
  ...
  "faqs": [
    [
      "What is Venture Capital Funding Legal Support?",
      "Venture Capital Funding Legal Support is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to venture capital funding legal support. The exact checklist can vary by case."
    ],
    [
