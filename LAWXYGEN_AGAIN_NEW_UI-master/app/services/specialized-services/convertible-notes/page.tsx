...
const data = {
  ...
  "summary": "A structured transaction workflow for convertible notes, keeping the deal context, documents and review milestones together.",
  "highlights": [
    "Issue framing",
    "Evidence pack",
    "Expert routing",
  ...
  "overview": [
    "Convertible Notes benefits from strong issue framing before a professional starts analysing the matter.",
  ...
  "faqs": [
    [
      ...
      "Convertible Notes is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to convertible notes. The exact checklist can vary by case."
    ],
    [
