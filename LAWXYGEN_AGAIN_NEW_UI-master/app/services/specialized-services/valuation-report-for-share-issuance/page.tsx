...
export const metadata: Metadata = {
  ...
  description: "Bring the facts, documents and decision points together before taking the next step on valuation report for share issuance.",
};
...
const data = {
  ...
  "variant": 23,
  "archetype": "advisory",
  "summary": "Bring the facts, documents and decision points together before taking the next step on valuation report for share issuance.",
  "highlights": [
    "Issue framing",
    "Evidence pack",
    "Expert routing",
  ...
  "overview": [
    "Valuation Report for Share Issuance benefits from strong issue framing before a professional starts analysing the matter.",
  ...
  "faqs": [
    [
      "What is Valuation Report for Share Issuance?",
      "Valuation Report for Share Issuance is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to valuation report for share issuance. The exact checklist can vary by case."
    ],
    [
