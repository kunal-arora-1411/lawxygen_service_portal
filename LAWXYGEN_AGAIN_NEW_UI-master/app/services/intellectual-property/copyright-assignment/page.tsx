...
export const metadata: Metadata = {
  ...
  description: "A specialist workflow for copyright assignment, from asset preparation through filing, response and record keeping.",
};
...
const data = {
  ...
  "variant": 0,
  "archetype": "ip",
  "summary": "A specialist workflow for copyright assignment, from asset preparation through filing, response and record keeping.",
  "highlights": [
    "Asset-led intake",
  ...
  "overview": [
    "Copyright Assignment depends on the underlying intellectual property asset, ownership position and filing or enforcement route.",
  ...
  "faqs": [
    [
      ...
      "Copyright Assignment is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to copyright assignment. The exact checklist can vary by case."
    ],
    [
