...
export const metadata: Metadata = {
  ...
  description: "A specialist workflow for copyright infringement advisory, from asset preparation through filing, response and record keeping.",
};
...
const data = {
  ...
  "variant": 23,
  "archetype": "ip",
  "summary": "A specialist workflow for copyright infringement advisory, from asset preparation through filing, response and record keeping.",
  "highlights": [
    "Asset-led intake",
  ...
  "overview": [
    "Copyright Infringement Advisory depends on the underlying intellectual property asset, ownership position and filing or enforcement route.",
  ...
  "faqs": [
    [
      "What is Copyright Infringement Advisory?",
      "Copyright Infringement Advisory is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to copyright infringement advisory. The exact checklist can vary by case."
    ],
    [
  ...
  "related": [
    ...
    },
    {
      ...
      "href": "/services/talk-ip-lawyer/patent-infringement-advisory"
    },
    {
