...
const data = {
  ...
  "variant": 16,
  "archetype": "ip",
  "summary": "A specialist workflow for ip litigation & infringement cases, from asset preparation through filing, response and record keeping.",
  "highlights": [
    "Asset-led intake",
  ...
  "overview": [
    "IP Litigation & Infringement Cases depends on the underlying intellectual property asset, ownership position and filing or enforcement route.",
  ...
  "faqs": [
    [
      "What is IP Litigation & Infringement Cases?",
      "IP Litigation & Infringement Cases is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to ip litigation & infringement cases. The exact checklist can vary by case."
    ],
    [
