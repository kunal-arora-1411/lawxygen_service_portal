...
const data = {
  ...
  "summary": "A focused consultation path for minutes of meetings (agm / egm), designed to make the issue easy for the right professional to assess.",
  "highlights": [
    "Issue framing",
    "Evidence pack",
    "Expert routing",
  ...
  "overview": [
    "Minutes of Meetings (AGM / EGM) benefits from strong issue framing before a professional starts analysing the matter.",
