...
export const metadata: Metadata = {
  ...
  description: "A clear LAWXYGEN workflow for isi certification, with concise guidance, preparation and an obvious next action.",
};
...
const data = {
  ...
  "variant": 7,
  "archetype": "general",
  "summary": "A clear LAWXYGEN workflow for isi certification, with concise guidance, preparation and an obvious next action.",
  "highlights": [
  ...
  "overview": [
    "ISI Certification is presented as a focused LAWXYGEN service journey rather than a generic information page.",
  ...
  "faqs": [
    [
      ...
      "ISI Certification is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to isi certification. The exact checklist can vary by case."
    ],
    [
