...
export const metadata: Metadata = {
  ...
  description: "Build pollution control certificate (noc) around the right parties, commercial terms, clauses and review points.",
};
...
const data = {
  ...
  "summary": "Build pollution control certificate (noc) around the right parties, commercial terms, clauses and review points.",
  "highlights": [
    "Party details",
    "Commercial terms",
    "Clause review",
  ...
  "overview": [
    "Pollution Control Certificate (NOC) works best when the document reflects the actual transaction, relationship and commercial intent rather than generic wording.",
  ...
  "faqs": [
    [
      "What is Pollution Control Certificate (NOC)?",
      "Pollution Control Certificate (NOC) is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to pollution control certificate (noc). The exact checklist can vary by case."
    ],
    [
