...
const data = {
  ...
  "summary": "Keep income tax return (itr) filing – individuals organised around records, review points and the next filing or response.",
  "highlights": [
    "Period-aware",
    "Record review",
    "Submission path",
  ...
  "overview": [
    "Income Tax Return (ITR) Filing – Individuals is most effective when the source records are prepared before the filing, review or response stage begins.",
  ...
  "faqs": [
    [
      "What is Income Tax Return (ITR) Filing – Individuals?",
      "Income Tax Return (ITR) Filing – Individuals is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to income tax return (itr) filing – individuals. The exact checklist can vary by case."
    ],
    [
