...
export const metadata: Metadata = {
  ...
  description: "A clear LAWXYGEN workflow for financial statement preparation (p&l, balance sheet), with concise guidance, preparation and an obvious next action.",
};
...
const data = {
  ...
  "variant": 5,
  "archetype": "general",
  "summary": "A clear LAWXYGEN workflow for financial statement preparation (p&l, balance sheet), with concise guidance, preparation and an obvious next action.",
  "highlights": [
  ...
  "overview": [
    "Financial Statement Preparation (P&L, Balance Sheet) is presented as a focused LAWXYGEN service journey rather than a generic information page.",
  ...
  "faqs": [
    [
      "What is Financial Statement Preparation (P&L, Balance Sheet)?",
      "Financial Statement Preparation (P&L, Balance Sheet) is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to financial statement preparation (p&l, balance sheet). The exact checklist can vary by case."
    ],
    [
