...
const data = {
  ...
  "variant": 9,
  "archetype": "general",
  "summary": "A clear LAWXYGEN workflow for mou (memorandum of understanding), with concise guidance, preparation and an obvious next action.",
  "highlights": [
  ...
  "overview": [
    "MOU (Memorandum of Understanding) is presented as a focused LAWXYGEN service journey rather than a generic information page.",
  ...
  "faqs": [
    [
      ...
      "MOU (Memorandum of Understanding) is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to mou (memorandum of understanding). The exact checklist can vary by case."
    ],
    [
