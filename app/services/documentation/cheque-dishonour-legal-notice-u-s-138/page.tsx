...
const data = {
  ...
  "summary": "Keep cheque dishonour (legal notice u/s 138) organised around records, review points and the next filing or response.",
  "highlights": [
    "Period-aware",
    "Record review",
    "Submission path",
  ...
  "overview": [
    "Cheque Dishonour (Legal Notice u/s 138) is most effective when the source records are prepared before the filing, review or response stage begins.",
  ...
  "faqs": [
    [
      "What is Cheque Dishonour (Legal Notice u/s 138)?",
      "Cheque Dishonour (Legal Notice u/s 138) is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to cheque dishonour (legal notice u/s 138). The exact checklist can vary by case."
    ],
    [
