...
export const metadata: Metadata = {
  ...
  description: "A focused consultation path for labour & employment disputes, designed to make the issue easy for the right professional to assess.",
};
...
const data = {
  ...
  "summary": "A focused consultation path for labour & employment disputes, designed to make the issue easy for the right professional to assess.",
  "highlights": [
    "Issue framing",
    "Evidence pack",
    "Expert routing",
  ...
  "overview": [
    "Labour & Employment Disputes benefits from strong issue framing before a professional starts analysing the matter.",
  ...
  "faqs": [
    [
      "What is Labour & Employment Disputes?",
      "Labour & Employment Disputes is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to labour & employment disputes. The exact checklist can vary by case."
    ],
    [
