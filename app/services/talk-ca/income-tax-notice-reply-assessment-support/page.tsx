...
export const metadata: Metadata = {
  ...
  description: "Keep income tax notice reply / assessment support organised around records, review points and the next filing or response.",
};
...
const data = {
  ...
  "summary": "Keep income tax notice reply / assessment support organised around records, review points and the next filing or response.",
  "highlights": [
    "Period-aware",
    "Record review",
    "Submission path",
  ...
  "overview": [
    "Income Tax Notice Reply / Assessment Support is most effective when the source records are prepared before the filing, review or response stage begins.",
  ...
  "faqs": [
    [
      "What is Income Tax Notice Reply / Assessment Support?",
      "Income Tax Notice Reply / Assessment Support is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to income tax notice reply / assessment support. The exact checklist can vary by case."
    ],
    [
  ...
  "related": [
    ...
    },
    {
      ...
      "href": "/services/talk-ca/income-tax-audit-section-44ab"
    },
    {
