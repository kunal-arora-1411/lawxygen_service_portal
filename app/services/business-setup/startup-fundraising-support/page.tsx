...
export const metadata: Metadata = {
  ...
  description: "Bring the facts, documents and decision points together before taking the next step on startup fundraising support.",
};
...
const data = {
  ...
  "variant": 13,
  "archetype": "advisory",
  "summary": "Bring the facts, documents and decision points together before taking the next step on startup fundraising support.",
  "highlights": [
    "Issue framing",
    "Evidence pack",
    "Expert routing",
  ...
  "overview": [
    "Startup Fundraising Support benefits from strong issue framing before a professional starts analysing the matter.",
  ...
  "faqs": [
    [
      "What is Startup Fundraising Support?",
      "Startup Fundraising Support is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to startup fundraising support. The exact checklist can vary by case."
    ],
    [
