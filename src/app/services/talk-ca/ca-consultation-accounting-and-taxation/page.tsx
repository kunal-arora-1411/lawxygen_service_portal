...
const data = {
  ...
  "summary": "Keep ca consultation – accounting & taxation organised around records, review points and the next filing or response.",
  "highlights": [
    "Period-aware",
    "Record review",
    "Submission path",
  ...
  "overview": [
    "CA Consultation – Accounting & Taxation is most effective when the source records are prepared before the filing, review or response stage begins.",
  ...
  "faqs": [
    [
      "What is CA Consultation – Accounting & Taxation?",
      "CA Consultation – Accounting & Taxation is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to ca consultation – accounting & taxation. The exact checklist can vary by case."
    ],
    [
