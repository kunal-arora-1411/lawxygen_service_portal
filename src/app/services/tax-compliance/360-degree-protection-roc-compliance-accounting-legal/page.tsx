...
export const metadata: Metadata = {
  ...
  description: "Keep 360 degree protection – roc compliance + accounting + legal organised around records, review points and the next filing or response.",
};
...
const data = {
  ...
  "summary": "Keep 360 degree protection – roc compliance + accounting + legal organised around records, review points and the next filing or response.",
  "highlights": [
    "Period-aware",
    "Record review",
    "Submission path",
  ...
  "overview": [
    "360 Degree Protection – ROC Compliance + Accounting + Legal is most effective when the source records are prepared before the filing, review or response stage begins.",
  ...
  "faqs": [
    [
      "What is 360 Degree Protection – ROC Compliance + Accounting + Legal?",
      "360 Degree Protection – ROC Compliance + Accounting + Legal is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to 360 degree protection – roc compliance + accounting + legal. The exact checklist can vary by case."
    ],
    [
