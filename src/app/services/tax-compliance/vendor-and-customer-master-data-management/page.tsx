...
const data = {
  ...
  "variant": 2,
  "archetype": "general",
  "summary": "A clear LAWXYGEN workflow for vendor & customer master data management, with concise guidance, preparation and an obvious next action.",
  "highlights": [
  ...
  "overview": [
    "Vendor & Customer Master Data Management is presented as a focused LAWXYGEN service journey rather than a generic information page.",
  ...
  "faqs": [
    [
      "What is Vendor & Customer Master Data Management?",
      "Vendor & Customer Master Data Management is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to vendor & customer master data management. The exact checklist can vary by case."
    ],
    [
