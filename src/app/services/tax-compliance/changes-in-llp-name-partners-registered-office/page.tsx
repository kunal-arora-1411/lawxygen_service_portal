...
export const metadata: Metadata = {
  ...
  description: "A clear LAWXYGEN workflow for changes in llp (name, partners, registered office), with concise guidance, preparation and an obvious next action.",
};
...
const data = {
  ...
  "variant": 19,
  "archetype": "general",
  "summary": "A clear LAWXYGEN workflow for changes in llp (name, partners, registered office), with concise guidance, preparation and an obvious next action.",
  "highlights": [
  ...
  "overview": [
    "Changes in LLP (Name, Partners, Registered Office) is presented as a focused LAWXYGEN service journey rather than a generic information page.",
  ...
  "faqs": [
    [
      "What is Changes in LLP (Name, Partners, Registered Office)?",
      "Changes in LLP (Name, Partners, Registered Office) is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to changes in llp (name, partners, registered office). The exact checklist can vary by case."
    ],
    [
