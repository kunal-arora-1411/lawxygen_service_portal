...
const data = {
  ...
  "summary": "Keep tds certificate (form 16 / 16a) generation organised around records, review points and the next filing or response.",
  "highlights": [
    "Period-aware",
    "Record review",
    "Submission path",
  ...
  "overview": [
    "TDS Certificate (Form 16 / 16A) Generation is most effective when the source records are prepared before the filing, review or response stage begins.",
  ...
  "faqs": [
    [
      "What is TDS Certificate (Form 16 / 16A) Generation?",
      "TDS Certificate (Form 16 / 16A) Generation is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to tds certificate (form 16 / 16a) generation. The exact checklist can vary by case."
    ],
    [
