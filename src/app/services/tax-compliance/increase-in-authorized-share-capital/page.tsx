...
export const metadata: Metadata = {
  ...
  description: "A clear LAWXYGEN workflow for increase in authorized share capital, with concise guidance, preparation and an obvious next action.",
};
...
const data = {
  ...
  "variant": 22,
  "archetype": "general",
  "summary": "A clear LAWXYGEN workflow for increase in authorized share capital, with concise guidance, preparation and an obvious next action.",
  "highlights": [
  ...
  "overview": [
    "Increase in Authorized Share Capital is presented as a focused LAWXYGEN service journey rather than a generic information page.",
