...
const data = {
  ...
  "variant": 12,
  "archetype": "general",
  "summary": "A clear LAWXYGEN workflow for changes in private limited company (name, address, directors, moa/aoa), with concise guidance, preparation and an obvious next action.",
  "highlights": [
  ...
  "overview": [
    "Changes in Private Limited Company (Name, Address, Directors, MOA/AOA) is presented as a focused LAWXYGEN service journey rather than a generic information page.",
  ...
  "faqs": [
    [
      "What is Changes in Private Limited Company (Name, Address, Directors, MOA/AOA)?",
      "Changes in Private Limited Company (Name, Address, Directors, MOA/AOA) is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to changes in private limited company (name, address, directors, moa/aoa). The exact checklist can vary by case."
    ],
    [
