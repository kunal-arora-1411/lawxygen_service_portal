...
export const metadata: Metadata = {
  ...
  description: "A clear LAWXYGEN workflow for conversion of business structure, with concise guidance, preparation and an obvious next action.",
};
...
const data = {
  ...
  "variant": 17,
  "archetype": "general",
  "summary": "A clear LAWXYGEN workflow for conversion of business structure, with concise guidance, preparation and an obvious next action.",
  "highlights": [
  ...
  "overview": [
    "Conversion of Business Structure is presented as a focused LAWXYGEN service journey rather than a generic information page.",
