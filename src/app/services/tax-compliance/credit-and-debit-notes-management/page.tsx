...
const data = {
  ...
  "summary": "A structured transaction workflow for credit & debit notes management, keeping the deal context, documents and review milestones together.",
  "highlights": [
    "Issue framing",
    "Evidence pack",
    "Expert routing",
  ...
  "overview": [
    "Credit & Debit Notes Management benefits from strong issue framing before a professional starts analysing the matter.",
  ...
  "faqs": [
    [
      "What is Credit & Debit Notes Management?",
      "Credit & Debit Notes Management is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to credit & debit notes management. The exact checklist can vary by case."
    ],
    [
