...
export const metadata: Metadata = {
  ...
  description: "A clear LAWXYGEN workflow for appointment / resignation of director, with concise guidance, preparation and an obvious next action.",
};
...
const data = {
  ...
  "variant": 21,
  "archetype": "general",
  "summary": "A clear LAWXYGEN workflow for appointment / resignation of director, with concise guidance, preparation and an obvious next action.",
  "highlights": [
  ...
  "overview": [
    "Appointment / Resignation of Director is presented as a focused LAWXYGEN service journey rather than a generic information page.",
