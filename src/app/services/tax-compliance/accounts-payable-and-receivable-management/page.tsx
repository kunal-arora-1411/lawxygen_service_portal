...
export const metadata: Metadata = {
  ...
  description: "A clear LAWXYGEN workflow for accounts payable & receivable management, with concise guidance, preparation and an obvious next action.",
};
...
const data = {
  ...
  "variant": 11,
  "archetype": "general",
  "summary": "A clear LAWXYGEN workflow for accounts payable & receivable management, with concise guidance, preparation and an obvious next action.",
  "highlights": [
  ...
  "overview": [
    "Accounts Payable & Receivable Management is presented as a focused LAWXYGEN service journey rather than a generic information page.",
  ...
  "faqs": [
    [
      ...
      "Accounts Payable & Receivable Management is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to accounts payable & receivable management. The exact checklist can vary by case."
    ],
    [
