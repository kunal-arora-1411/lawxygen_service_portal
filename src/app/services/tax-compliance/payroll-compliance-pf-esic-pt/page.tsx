...
export const metadata: Metadata = {
  ...
  description: "Keep payroll compliance (pf, esic, pt) organised around records, review points and the next filing or response.",
};
...
const data = {
  ...
  "summary": "Keep payroll compliance (pf, esic, pt) organised around records, review points and the next filing or response.",
  "highlights": [
    "Period-aware",
    "Record review",
    "Submission path",
  ...
  "overview": [
    "Payroll Compliance (PF, ESIC, PT) is most effective when the source records are prepared before the filing, review or response stage begins.",
  ...
  "faqs": [
    [
      "What is Payroll Compliance (PF, ESIC, PT)?",
      "Payroll Compliance (PF, ESIC, PT) is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to payroll compliance (pf, esic, pt). The exact checklist can vary by case."
    ],
    [
