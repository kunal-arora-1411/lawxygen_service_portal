...
export const metadata: Metadata = {
  ...
  description: "Keep rbi compliance for foreign investment (fdi / fpi) organised around records, review points and the next filing or response.",
};
...
const data = {
  ...
  "summary": "Keep rbi compliance for foreign investment (fdi / fpi) organised around records, review points and the next filing or response.",
  "highlights": [
    "Period-aware",
    "Record review",
    "Submission path",
  ...
  "overview": [
    "RBI Compliance for Foreign Investment (FDI / FPI) is most effective when the source records are prepared before the filing, review or response stage begins.",
  ...
  "faqs": [
    [
      "What is RBI Compliance for Foreign Investment (FDI / FPI)?",
      "RBI Compliance for Foreign Investment (FDI / FPI) is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to rbi compliance for foreign investment (fdi / fpi). The exact checklist can vary by case."
    ],
    [
