...
export const metadata: Metadata = {
  ...
  description: "A focused consultation path for changes in company structure (name, address, moa/aoa), designed to make the issue easy for the right professional to assess.",
};
...
const data = {
  ...
  "summary": "A focused consultation path for changes in company structure (name, address, moa/aoa), designed to make the issue easy for the right professional to assess.",
  "highlights": [
    "Issue framing",
    "Evidence pack",
    "Expert routing",
  ...
  "overview": [
    "Changes in Company Structure (Name, Address, MOA/AOA) benefits from strong issue framing before a professional starts analysing the matter.",
  ...
  "faqs": [
    [
      "What is Changes in Company Structure (Name, Address, MOA/AOA)?",
      "Changes in Company Structure (Name, Address, MOA/AOA) is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to changes in company structure (name, address, moa/aoa). The exact checklist can vary by case."
    ],
    [
