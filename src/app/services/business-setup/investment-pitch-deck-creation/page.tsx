...
const data = {
  ...
  "variant": 11,
  "archetype": "general",
  "summary": "A clear LAWXYGEN workflow for investment pitch deck creation, with concise guidance, preparation and an obvious next action.",
  "highlights": [
  ...
  "overview": [
    "Investment Pitch Deck Creation is presented as a focused LAWXYGEN service journey rather than a generic information page.",
  ...
  "faqs": [
    [
      "What is Investment Pitch Deck Creation?",
      "Investment Pitch Deck Creation is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to investment pitch deck creation. The exact checklist can vary by case."
    ],
    [
