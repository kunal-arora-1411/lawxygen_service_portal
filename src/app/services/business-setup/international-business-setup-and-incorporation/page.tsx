...
const data = {
  ...
  "summary": "A guided path for international business setup & incorporation that keeps preparation, filing and follow-up easy to understand.",
  "highlights": [
  ...
  "overview": [
    "International Business Setup & Incorporation is a structured business or legal setup service. The first step is to understand who is applying, what outcome is required and which route applies.",
  ...
  "faqs": [
    [
      "What is International Business Setup & Incorporation?",
      "International Business Setup & Incorporation is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to international business setup & incorporation. The exact checklist can vary by case."
    ],
    [
