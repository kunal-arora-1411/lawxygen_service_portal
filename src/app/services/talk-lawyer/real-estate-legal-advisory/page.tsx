...
const data = {
  ...
  "variant": 9,
  "archetype": "advisory",
  "summary": "Bring the facts, documents and decision points together before taking the next step on real estate legal advisory.",
  "highlights": [
    "Issue framing",
    "Evidence pack",
    "Expert routing",
  ...
  "overview": [
    "Real Estate Legal Advisory benefits from strong issue framing before a professional starts analysing the matter.",
  ...
  "faqs": [
    [
      "What is Real Estate Legal Advisory?",
      "Real Estate Legal Advisory is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to real estate legal advisory. The exact checklist can vary by case."
    ],
    [
