...
export const metadata: Metadata = {
  ...
  description: "Bring the facts, documents and decision points together before taking the next step on cyber crime legal support.",
};
...
const data = {
  ...
  "variant": 18,
  "archetype": "advisory",
  "summary": "Bring the facts, documents and decision points together before taking the next step on cyber crime legal support.",
  "highlights": [
    "Issue framing",
    "Evidence pack",
    "Expert routing",
  ...
  "overview": [
    "Cyber Crime Legal Support benefits from strong issue framing before a professional starts analysing the matter.",
  ...
  "faqs": [
    [
      "What is Cyber Crime Legal Support?",
      "Cyber Crime Legal Support is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to cyber crime legal support. The exact checklist can vary by case."
    ],
    [
