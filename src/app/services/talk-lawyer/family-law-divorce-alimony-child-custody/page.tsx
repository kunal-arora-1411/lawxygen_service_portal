...
export const metadata: Metadata = {
  ...
  description: "A focused consultation path for family law – divorce, alimony, child custody, designed to make the issue easy for the right professional to assess.",
};
...
const data = {
  ...
  "summary": "A focused consultation path for family law – divorce, alimony, child custody, designed to make the issue easy for the right professional to assess.",
  "highlights": [
    "Issue framing",
    "Evidence pack",
    "Expert routing",
  ...
  "overview": [
    "Family Law – Divorce, Alimony, Child Custody benefits from strong issue framing before a professional starts analysing the matter.",
  ...
  "faqs": [
    [
      "What is Family Law – Divorce, Alimony, Child Custody?",
      "Family Law – Divorce, Alimony, Child Custody is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to family law – divorce, alimony, child custody. The exact checklist can vary by case."
    ],
    [
  ...
  "related": [
    ...
    },
    {
      ...
      "href": "/services/talk-lawyer/cyber-crime-legal-support"
    }
  ],
