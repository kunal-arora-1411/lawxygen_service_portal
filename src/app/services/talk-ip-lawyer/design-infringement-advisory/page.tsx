...
const data = {
  ...
  "variant": 12,
  "archetype": "ip",
  "summary": "A specialist workflow for design infringement advisory, from asset preparation through filing, response and record keeping.",
  "highlights": [
    "Asset-led intake",
  ...
  "overview": [
    "Design Infringement Advisory depends on the underlying intellectual property asset, ownership position and filing or enforcement route.",
  ...
  "faqs": [
    [
      "What is Design Infringement Advisory?",
      "Design Infringement Advisory is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to design infringement advisory. The exact checklist can vary by case."
    ],
    [
