...
export const metadata: Metadata = {
  ...
  description: "A structured transaction workflow for equity shares issuance, keeping the deal context, documents and review milestones together.",
};
...
const data = {
  ...
  "summary": "A structured transaction workflow for equity shares issuance, keeping the deal context, documents and review milestones together.",
  "highlights": [
    "Issue framing",
    "Evidence pack",
    "Expert routing",
  ...
  "overview": [
    "Equity Shares Issuance benefits from strong issue framing before a professional starts analysing the matter.",
  ...
  "faqs": [
    [
      "What is Equity Shares Issuance?",
      "Equity Shares Issuance is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to equity shares issuance. The exact checklist can vary by case."
    ],
    [
