...
export const metadata: Metadata = {
  ...
  description: "A structured transaction workflow for ccd (compulsorily convertible debentures) issuance, keeping the deal context, documents and review milestones together.",
};
...
const data = {
  ...
  "summary": "A structured transaction workflow for ccd (compulsorily convertible debentures) issuance, keeping the deal context, documents and review milestones together.",
  "highlights": [
    "Issue framing",
    "Evidence pack",
    "Expert routing",
  ...
  "overview": [
    "CCD (Compulsorily Convertible Debentures) Issuance benefits from strong issue framing before a professional starts analysing the matter.",
  ...
  "faqs": [
    [
      "What is CCD (Compulsorily Convertible Debentures) Issuance?",
      "CCD (Compulsorily Convertible Debentures) Issuance is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to ccd (compulsorily convertible debentures) issuance. The exact checklist can vary by case."
    ],
    [
