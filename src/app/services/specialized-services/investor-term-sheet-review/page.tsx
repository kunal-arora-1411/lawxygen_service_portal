...
const data = {
  ...
  "variant": 12,
  "archetype": "advisory",
  "summary": "Bring the facts, documents and decision points together before taking the next step on investor term sheet review.",
  "highlights": [
    "Issue framing",
    "Evidence pack",
    "Expert routing",
  ...
  "overview": [
    "Investor Term Sheet Review benefits from strong issue framing before a professional starts analysing the matter.",
  ...
  "faqs": [
    [
      "What is Investor Term Sheet Review?",
      "Investor Term Sheet Review is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to investor term sheet review. The exact checklist can vary by case."
    ],
    [
