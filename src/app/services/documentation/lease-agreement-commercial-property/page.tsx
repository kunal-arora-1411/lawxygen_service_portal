...
export const metadata: Metadata = {
  ...
  description: "Build lease agreement (commercial property) around the right parties, commercial terms, clauses and review points.",
};
...
const data = {
  ...
  "summary": "Build lease agreement (commercial property) around the right parties, commercial terms, clauses and review points.",
  "highlights": [
    "Party details",
    "Commercial terms",
    "Clause review",
  ...
  "overview": [
    "Lease Agreement (Commercial Property) works best when the document reflects the actual transaction, relationship and commercial intent rather than generic wording.",
  ...
  "faqs": [
    [
      "What is Lease Agreement (Commercial Property)?",
      "Lease Agreement (Commercial Property) is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to lease agreement (commercial property). The exact checklist can vary by case."
    ],
    [
