...
export const metadata: Metadata = {
  ...
  description: "Build franchisee agreement around the right parties, commercial terms, clauses and review points.",
};
...
const data = {
  ...
  "summary": "Build franchisee agreement around the right parties, commercial terms, clauses and review points.",
  "highlights": [
    "Party details",
    "Commercial terms",
    "Clause review",
  ...
  "overview": [
    "Franchisee Agreement works best when the document reflects the actual transaction, relationship and commercial intent rather than generic wording.",
  ...
  "faqs": [
    [
      "What is Franchisee Agreement?",
      "Franchisee Agreement is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to franchisee agreement. The exact checklist can vary by case."
    ],
    [
