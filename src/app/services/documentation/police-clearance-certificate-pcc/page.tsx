...
export const metadata: Metadata = {
  ...
  description: "Build police clearance certificate (pcc) around the right parties, commercial terms, clauses and review points.",
};
...
const data = {
  ...
  "summary": "Build police clearance certificate (pcc) around the right parties, commercial terms, clauses and review points.",
  "highlights": [
    "Party details",
    "Commercial terms",
    "Clause review",
  ...
  "overview": [
    "Police Clearance Certificate (PCC) works best when the document reflects the actual transaction, relationship and commercial intent rather than generic wording.",
  ...
  "faqs": [
    [
      ...
      "Police Clearance Certificate (PCC) is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to police clearance certificate (pcc). The exact checklist can vary by case."
    ],
    [
