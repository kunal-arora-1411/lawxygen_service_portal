...
export const metadata: Metadata = {
  ...
  description: "A clear LAWXYGEN workflow for name change (gazette notification), with concise guidance, preparation and an obvious next action.",
};
...
const data = {
  ...
  "variant": 19,
  "archetype": "general",
  "summary": "A clear LAWXYGEN workflow for name change (gazette notification), with concise guidance, preparation and an obvious next action.",
  "highlights": [
  ...
  "overview": [
    "Name Change (Gazette Notification) is presented as a focused LAWXYGEN service journey rather than a generic information page.",
  ...
  "faqs": [
    [
      ...
      "Name Change (Gazette Notification) is a LAWXYGEN service pathway focused on the outcome described on this page. The precise route depends on the client facts and the applicable workflow."
    ],
    [
      "What should I prepare before starting?",
      "Keep the client profile, core matter details and the supporting records relevant to name change (gazette notification). The exact checklist can vary by case."
    ],
    [
